...
class MyTests(unittest.TestCase):
    ...
    def test_remove_floor(self):
        self.assertEqual(remove_floor(read_file('test_input_1.txt')),['L#', '#L'])
        self.assertEqual(remove_floor(read_file('test_input.txt')),['LLLLLLL000', 'LLLLLLLLL0', 'LLLL000000', 'LLLLLLLL00', 'LLLLLLL000', 'LLLLLLLL00', 'LL00000000', 'LLLLLLLLLL', 'LLLLLLLL00', 'LLLLLLLL00'])
